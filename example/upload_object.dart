...
void main() {
  ...
  bucketApi.uploadObjectBytes('hello-from-bucket-api2.html', UTF8.encode("<html><head></head><body><h1>hello from aws_rest2!</h1></body></html>"), headers: {'content-type' : 'text/html', 'content-encoding' : 'gzip'}).then((_) {
